    ...
    public function request_form($hide_contact_form)
    {
        ...
        ?>
            ...
            <div id="aircraft_booking_container" class="<?php echo ($hide_contact_form) ? 'hidden' : ''; ?> animate-fade">
                ...
                <form data-method="post" id="aircraft_booking_request" data-hash-params="<?php echo esc_attr(implode(',', $this->utilities->request_form_hash_param_names()));?>" data-action="<?php echo esc_attr(base64_encode(normalize_url($this->home_lang.'/request_submitted')));?>">
